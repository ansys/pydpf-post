...
===============================
This example shows how to request data from a previously stored transient simulation.
...
# -----------------------------------
# Request displacements only for the selected time steps. Note that ``steps`` argument
# allows you to select a certain time-step by its index (integers from 1 to n_time_steps).
...
###############################################################################
# Print information. Note that only 58 nodes were found with IDs between
# 1000 and 1400.
print(nodal_stress)
